  ...
  return (
    <Fragment>
      <div className="form-item focus:border-secondary-bg dark:focus:border-secondary-bg-dark"style={{marginTop : "5%"}}>
        ...
        <label style={{borderRadius : "10px"}} className="peer-focus:text-secondary-bg dark:peer-focus:text-secondary-bg-dark bg-white dark:text-inactive-txt-dark dark:bg-primary-bg-dark" htmlFor={label}>{label}</label>
      </div>
    </Fragment>
  );
};
